...
![向导步骤截图](/img/in-post/vii-a-first-run-wizard-1.jpg)
...
![向导步骤截图](/img/in-post/vii-a-first-run-wizard-2.jpg)

> * 上图默认选择中的是 `Buy IntelliJ IDEA`，验证 IntelliJ IDEA 的许可有如图三种方式，我们这里使用的是 30 天试用版本进行演示，顾单击 `Evaluate for free for 30 days` 进行下一步。

![向导步骤截图](/img/in-post/vii-a-first-run-wizard-3.jpg)

![向导步骤截图](/img/in-post/vii-a-first-run-wizard-4.jpg)
...
![向导步骤截图](/img/in-post/vii-a-first-run-wizard-5.jpg)
...
![向导步骤截图](/img/in-post/vii-a-first-run-wizard-6.jpg)
...
![向导步骤截图](/img/in-post/vii-a-first-run-wizard-7.jpg)
