---
layout:     post
title:      "IDEA系列（九）Intellij IDEA界面介绍"
subtitle:   ""
date:       2017-04-29 12:00:09
author:     "Crimps"
...
![首次打开](/img/in-post/ix-interface-introduce-1.jpg)
...
![新建 HTML 项目](/img/in-post/ix-interface-introduce-2.jpg)

![新建 HTML 项目](/img/in-post/ix-interface-introduce-3.jpg)

## 界面介绍

![界面介绍](/img/in-post/ix-interface-introduce-4.jpg)
...
![界面介绍](/img/in-post/ix-interface-introduce-5.jpg)

> * 如上图，IntelliJ IDEA 默认界面是隐藏掉 `Toolbar` 和 `Tool Buttons`，我个人习惯看到这两个，所以一般都会进行开启。

![界面介绍](/img/in-post/ix-interface-introduce-6.jpg)
