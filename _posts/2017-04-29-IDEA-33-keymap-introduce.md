---
layout:     post
title:      "IDEA系列（三十三） 常用快捷键讲解(Win + Linux)"
subtitle:   ""
date:       2017-04-29 12:00:33
author:     "Crimps"
...
![前提](/img/in-post/xxvii-c-keymap-premise-1.jpg)

> * 如上图红色圈住内容所示，默认是 `逗号` 我改为了 ESC 键下的 `波浪号`，`Ctrl + 逗号` 这个快捷键适合做智能提示用，下面的快捷键列表会讲。

![前提](/img/in-post/xxvii-c-keymap-premise-2.jpg)

> * 如上图红色圈住内容所示，这些快捷键很容易跟 IntelliJ IDEA 快捷键冲突，需要全部去掉。

![前提](/img/in-post/xxvii-c-keymap-premise-3.jpg)
...
![前提](/img/in-post/xxvii-d-keymap-learn-1.gif)
...
![修改快捷键](/img/in-post/xxvii-a-keymap-setting-1.jpg)
...
![修改快捷键](/img/in-post/xxvii-a-keymap-setting-2.jpg)
