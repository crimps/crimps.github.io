---
layout:     post
title:      "IDEA系列（三十一） 常用设置-3"
subtitle:   ""
date:       2017-04-29 12:00:31
author:     "Crimps"
...
![常用设置](/img/in-post/xxvi-a-settings-introduce-39.jpg)

> * 如上图所示，不管是用 IntelliJ IDEA 打开新文件，或是在安装本地插件，在弹出的窗口中，图 1 按钮支持快速定位到系统桌面目录，图 2 按钮支持快速定位到当前项目目录。

![常用设置](/img/in-post/xxvi-a-settings-introduce-40.jpg)
