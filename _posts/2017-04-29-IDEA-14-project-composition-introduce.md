---
layout:     post
title:      "IDEA系列（十四） 项目相关的几个重要概念介绍"
subtitle:   ""
date:       2017-04-29 12:00:14
author:     "Crimps"
...
![Project 和 Module 介绍](/img/in-post/xiv-a-project-and-module-introduce-1.gif)
...
![SDK 介绍](/img/in-post/xiv-b-sdk-introduce-1.jpg)
...
![SDK 介绍](/img/in-post/xiv-b-sdk-introduce-2.jpg)
...
![language level 介绍](/img/in-post/xiv-c-language-level-introduce-1.jpg)

![language level 介绍](/img/in-post/xiv-c-language-level-introduce-2.jpg)
...
![Module 下的 SDK 和 language level](/img/in-post/xiv-d-module-setting-1.jpg)

> * 如上图标注 1 所示，可以针对 Module 选择其他 SDK，默认选择的是 `Project SDK`

![Module 下的 SDK 和 language level](/img/in-post/xiv-d-module-setting-2.jpg)
